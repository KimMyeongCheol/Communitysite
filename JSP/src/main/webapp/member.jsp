		...
		<table class="table table-hover">
			<tbody>
				<tr  class="table-primary" >
					<td class="req" >아이디</td>
					<td>
						<input for="inputId"  type="text" id="uId" name="uId" size="15" 
				...
				<tr  class="table-primary">
					<td class="req" for="inputPassword" >패스워드</td>
					<td>
				...
				<tr >
					<td>성별</td>
					<td>
					 	<label for="inputPhoneNumber" class="col-lg-2 control-label">Male <input type="radio" name="uGender" value="1" checked></label>
					 	<label for="inputPhoneNumber" class="col-lg-2 control-label">Female <input type="radio" name="uGender" value="0"></label>
					</td>
					<td>성별을 선택하세요.</td>
				</tr>
				<tr >
				...
				<tr>
					<td colspan="3">
						...
						<button type="button" id="back"><a href="index.jsp">돌아가기</a></button>					
					</td>
				</tr>
			</tbody>
		</table>
